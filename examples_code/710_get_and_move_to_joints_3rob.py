...
if __name__ == '__main__':
    ...
    robot_joints1.rax_1 = -90
    robot_joints1.rax_2 = 1
    robot_joints1.rax_3 = 1
    robot_joints1.rax_4 = 2
    robot_joints1.rax_5 = 3
    robot_joints1.rax_6 = 4

    robot_joints2.rax_1 = 0
    robot_joints2.rax_2 = 1
    robot_joints2.rax_3 = 1
    robot_joints2.rax_4 = 2
    robot_joints2.rax_5 = 3
    robot_joints2.rax_6 = 4
    ...
    # Print feedback
    print('Feedback = ', done1, done2, done3)
